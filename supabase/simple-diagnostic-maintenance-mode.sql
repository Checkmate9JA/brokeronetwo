-- Simple Diagnostic for Maintenance Mode Foreign Key Issue
...
-- 4. Check the foreign key constraints (simplified)
SELECT 
...
-- 9. Quick test - can we read the tables?
SELECT 'Can read users table' as test, COUNT(*) as user_count FROM users;
SELECT 'Can read maintenance_mode table' as test, COUNT(*) as maintenance_count FROM maintenance_mode;

-- 10. Test the function directly
